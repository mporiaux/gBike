...
public class CompteurSimple {
  ...
  long delai;
  long dtot=0;
  private static CompteurSimple cs=null;
private CompteurSimple(float dimRoue,long delai,long rebond){
...
public static CompteurSimple getInstance(){
    if (cs==null) return cs=new CompteurSimple((float)2.1,2000,50);
    else return cs;
}
...
public boolean isFrein(){
 ...
 public static void main(String args[]){
     CompteurSimple cs=new CompteurSimple((float)2.1,2000,50);
     cs.tourne();
 }
