...
public class CapteurGraphSimple2 extends Frame implements ActionListener,MouseListener {
static{
  ...
  CommandeGStreet2 cgsa =new CommandeGStreet2();
 CommandeGStreet2 cgsb =new CommandeGStreet2();
  int depv=0,deph=0;
...
Robot robot=null;
  ...
  private static googlebike.CapteurGraphSimple2 cp=null;
int pente=0;
float distold=0;
...
public static googlebike.CapteurGraphSimple2 getInstance(){
   if (cp==null) return cp=new googlebike.CapteurGraphSimple2();
    else return cp;
}
...
do{
 ...
 public void actionPerformed(ActionEvent e) {
  ...
  public static void main(String args[]){
     ...
     googlebike.CapteurGraphSimple2 cp=googlebike.CapteurGraphSimple2.getInstance();
